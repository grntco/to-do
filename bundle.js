...
todayView.getTasks = function() {
    return JSON.parse(localStorage.getItem('allTasks')).filter((task) => (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(task.dueDate))
}
// Something like return  allTasks.filter((task) => task.dueDate.isNow())

const weekView = new TasksView('Week');
weekView.getTasks = function() {
    return JSON.parse(localStorage.getItem('allTasks')).filter((task) => ((0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(task.dueDate) || (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(task.dueDate, new Date())) && (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(task.dueDate, (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(new Date(), 6)));
}
