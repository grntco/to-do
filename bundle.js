...
/* harmony import */ var _viewContainer__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./viewContainer */ "./src/modules/viewContainer.js");
/* harmony import */ var _mainContainer__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./mainContainer */ "./src/modules/mainContainer.js");
...
function refreshContent() {
    const getSidebarStatus = function() {
        if (_mainContainer__WEBPACK_IMPORTED_MODULE_3__.d.querySelector('.sidebar').classList.contains('collapsed')) {
            return 'collapsed';
        }
    };
    ...
    const getCurrentView = function() {
        const viewName = _mainContainer__WEBPACK_IMPORTED_MODULE_3__.d.getElementById('view-name').textContent;
        console.log(viewName);
        switch (viewName) {
            case 'Inbox':
                return _app__WEBPACK_IMPORTED_MODULE_4__.inboxView;
                break;
            case 'Today':
                return _app__WEBPACK_IMPORTED_MODULE_4__.todayView;
                break;
            case 'Week':
                return _app__WEBPACK_IMPORTED_MODULE_4__.weekView;
                break;
            default:
                return _app__WEBPACK_IMPORTED_MODULE_4__.allProjects.find((project) => project.title === viewName);
        }
    }
    const currentView = getCurrentView();

    _mainContainer__WEBPACK_IMPORTED_MODULE_3__.mainContainer.innerHTML = '';

    (0,_sidebar__WEBPACK_IMPORTED_MODULE_1__.createSidebar)();

    if (previousSidebarStatus === 'collapsed') {
        (0,_sidebar__WEBPACK_IMPORTED_MODULE_1__.toggleSidebar)();
    }

    (0,_viewContainer__WEBPACK_IMPORTED_MODULE_2__.createViewContainer)(currentView);
}
