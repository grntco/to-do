...
inboxView.getTasks = function() {
    ...
    return (0,_localStorage__WEBPACK_IMPORTED_MODULE_0__.getFromLocalStorage)(allTasks).filter((task) => task.project === undefined);
}
...
todayView.getTasks = function() {
    ...
    return (0,_localStorage__WEBPACK_IMPORTED_MODULE_0__.getFromLocalStorage)(allTasks).filter((task) => (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(task.dueDate));
}
...
weekView.getTasks = function() {
    ...
    return (0,_localStorage__WEBPACK_IMPORTED_MODULE_0__.getFromLocalStorage)(allTasks).filter((task) => ((0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(task.dueDate) || (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(task.dueDate, new Date())) && (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(task.dueDate, (0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(new Date(), 6)));
}
...
function saveToLocalStorage(array) {
    ...
    array[0] instanceof _app__WEBPACK_IMPORTED_MODULE_0__.Task ? keyName = 'allTasks' : keyName = 'allProjects';
...
function getFromLocalStorage(array) {
    ...
    if (array[0] instanceof _app__WEBPACK_IMPORTED_MODULE_0__.Task) {
        ...
        if (array.length > 0) {
            array.forEach((item) => {
                item.add = function() {
                    ...
                    saveToLocalStorage(_app__WEBPACK_IMPORTED_MODULE_0__.allTasks);
                }
    ...
    } else if (array[0] instanceof _app__WEBPACK_IMPORTED_MODULE_0__.Project) {
        ...
        if (array.length > 0) {
            array.forEach((item) => {
                item.add = function() {
                    ...
                    saveToLocalStorage(_app__WEBPACK_IMPORTED_MODULE_0__.allProjects);
                }
...
function createSidebar() {
    ...
    const createProjectsViewListContainer = (function() {
        ...
        const createBtnsContainer = (function() {
            ...
            const savedProjects = (0,_localStorage__WEBPACK_IMPORTED_MODULE_1__.getFromLocalStorage)(_app__WEBPACK_IMPORTED_MODULE_0__.allProjects);
        ...
        const createTasks = (function() {
            for (let i = 0; i < view.getTasks().length; i++) {
                ...
                const createMetaContainer = (function() {
                    ...
                    dueDateTag.textContent = (0,date_fns_format__WEBPACK_IMPORTED_MODULE_1__["default"])((0,date_fns_parseISO__WEBPACK_IMPORTED_MODULE_2__["default"])(taskObj.dueDate), 'PP');
                })();
            } 
        })();
    })();
...
(0,_modules_localStorage__WEBPACK_IMPORTED_MODULE_6__.saveToLocalStorage)(_modules_app__WEBPACK_IMPORTED_MODULE_1__.allTasks);
