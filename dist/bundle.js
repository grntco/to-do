...
class Task {
    constructor(_title, _description, _dueDate, _priority, _project) {
        ...
        this.dueDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(new Date(_dueDate.split('-')), 'PP');
...
console.log(_modules_app__WEBPACK_IMPORTED_MODULE_1__.inboxView.getTasks());
