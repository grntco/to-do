...
todayView.getTasks = function() {
    return allTasks.filter((task) => (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(task.dueDate))
}
...
weekView.getTasks = function() {
    return allTasks.filter((task) => ((0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(task.dueDate) || (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(task.dueDate, new Date())) && (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(task.dueDate, (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(new Date(), 6)));
}
...
/* harmony import */ var _app__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./app */ "./src/modules/app.js");
...
const events = (function() {
    _mainContainer__WEBPACK_IMPORTED_MODULE_0__.d.addEventListener('click', function(e) {
        ...
        if (target.id === 'inbox-view-btn') {
            ...
            (0,_viewContainer__WEBPACK_IMPORTED_MODULE_3__.createViewContainer)(_app__WEBPACK_IMPORTED_MODULE_5__.inboxView)
        }

        if (target.id === 'today-view-btn') {
            (0,_viewContainer__WEBPACK_IMPORTED_MODULE_3__.removeViewContainer)();
            (0,_viewContainer__WEBPACK_IMPORTED_MODULE_3__.createViewContainer)(_app__WEBPACK_IMPORTED_MODULE_5__.todayView);
        }

        if (target.id === 'week-view-btn') {
            (0,_viewContainer__WEBPACK_IMPORTED_MODULE_3__.removeViewContainer)();
            (0,_viewContainer__WEBPACK_IMPORTED_MODULE_3__.createViewContainer)(_app__WEBPACK_IMPORTED_MODULE_5__.weekView);
        }

        if (target.classList.contains('project-sb-btn')) {
            const projectName = target.textContent.replace(/\d/g, '');
            const projectObj = _app__WEBPACK_IMPORTED_MODULE_5__.allProjects.find((project) => project.title === projectName);
            (0,_viewContainer__WEBPACK_IMPORTED_MODULE_3__.removeViewContainer)();
            (0,_viewContainer__WEBPACK_IMPORTED_MODULE_3__.createViewContainer)(projectObj);
        }

        if (target.id === 'add-task-btn') {
            (0,_forms__WEBPACK_IMPORTED_MODULE_4__.createNewTaskFormContainer)()
        }

        if (target.id === 'add-project-btn') {
            (0,_forms__WEBPACK_IMPORTED_MODULE_4__.createNewProjectModal)();
        }

        if (target.classList.contains('cancel-btn')) {
            e.preventDefault();
            (0,_forms__WEBPACK_IMPORTED_MODULE_4__.removeModal)();
        }

        if (target.classList.contains('task')) {
            const taskCard = target;
            const taskObj = _app__WEBPACK_IMPORTED_MODULE_5__.allTasks.find((task) => task.title === taskCard.querySelector('.name').textContent);
            (0,_forms__WEBPACK_IMPORTED_MODULE_4__.createEditTaskModal)(taskObj);
        }
    });
})();
...
/* harmony export */   createNewTaskFormContainer: () => (/* binding */ createNewTaskFormContainer),
...
function createNewProjectModal() {
    ...
    const newProjectModal = _mainContainer__WEBPACK_IMPORTED_MODULE_1__.mainContainer.appendChild(_mainContainer__WEBPACK_IMPORTED_MODULE_1__.d.createElement('div'));
    newProjectModal.classList.add('new-project-modal', 'modal');

    const createForm = (function() {
        const form = newProjectModal.appendChild(_mainContainer__WEBPACK_IMPORTED_MODULE_1__.d.createElement('form'));
...
function createNewTaskFormContainer() {
    ...
    const newTaskFormContainer = (0,_viewContainer__WEBPACK_IMPORTED_MODULE_2__.getViewContainer)().insertBefore(_mainContainer__WEBPACK_IMPORTED_MODULE_1__.d.createElement('div'), _mainContainer__WEBPACK_IMPORTED_MODULE_1__.d.getElementById('add-task-btn'));
    newTaskFormContainer.classList.add('new-task-form-container');

    const createForm = (function() {
        const form = newTaskFormContainer.appendChild(_mainContainer__WEBPACK_IMPORTED_MODULE_1__.d.createElement('form'));
...
function removeModal() {
    _mainContainer__WEBPACK_IMPORTED_MODULE_1__.mainContainer.removeChild(_mainContainer__WEBPACK_IMPORTED_MODULE_1__.d.querySelector('.modal'));
}
...
function toggleSidebar() {
    _mainContainer__WEBPACK_IMPORTED_MODULE_1__.d.querySelector('.sidebar').classList.toggle('collapse');
};
...
console.log(_modules_app__WEBPACK_IMPORTED_MODULE_1__.todayView.getTasks());
