...
/* harmony import */ var _ui_forms_removeModal__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../ui/forms/removeModal */ "./src/ui/forms/removeModal.js");
/* harmony import */ var _formHandlers__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./formHandlers */ "./src/app/formHandlers.js");
/* harmony import */ var _app__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./app */ "./src/app/app.js");
/* harmony import */ var _task__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./task */ "./src/app/task.js");
/* harmony import */ var _completeTask__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./completeTask */ "./src/app/completeTask.js");
...
const events = (function() {
    _ui_mainContainer__WEBPACK_IMPORTED_MODULE_0__.d.addEventListener('click', function(e) {
        ...
        if (target.id === 'inbox-view-btn') {
            ...
            (0,_ui_viewContainer__WEBPACK_IMPORTED_MODULE_3__.createViewContainer)(_app__WEBPACK_IMPORTED_MODULE_9__.inboxView)
        }

        if (target.id === 'today-view-btn') {
            (0,_ui_viewContainer__WEBPACK_IMPORTED_MODULE_3__.removeViewContainer)();
            (0,_ui_viewContainer__WEBPACK_IMPORTED_MODULE_3__.createViewContainer)(_app__WEBPACK_IMPORTED_MODULE_9__.todayView);
        }

        if (target.id === 'week-view-btn') {
            (0,_ui_viewContainer__WEBPACK_IMPORTED_MODULE_3__.removeViewContainer)();
            (0,_ui_viewContainer__WEBPACK_IMPORTED_MODULE_3__.createViewContainer)(_app__WEBPACK_IMPORTED_MODULE_9__.weekView);
        }
        ...
        if (target.id === 'create-task-btn') {
            e.preventDefault();
            (0,_formHandlers__WEBPACK_IMPORTED_MODULE_8__.createTask)();
        }
        ...
        if (target.id === 'create-project-btn') {
            e.preventDefault();
            (0,_formHandlers__WEBPACK_IMPORTED_MODULE_8__.createProject)();
        }

        if (target.id === 'done-edit-task-btn') {
            e.preventDefault()
            ;(0,_formHandlers__WEBPACK_IMPORTED_MODULE_8__.editTask)();
        }

        if (target.classList.contains('cancel-modal-btn')) {
            e.preventDefault();
            (0,_ui_forms_removeModal__WEBPACK_IMPORTED_MODULE_7__["default"])();
        }

        if (target.classList.contains('cancel-form-btn')) {
            e.preventDefault();
            (0,_ui_forms_newTaskForm__WEBPACK_IMPORTED_MODULE_4__.removeNewTaskForm)();
        }

        if (target.classList.contains('task')) {
            const taskCard = target;
            const taskObj = _task__WEBPACK_IMPORTED_MODULE_10__.allTasks.find((task) => task.title === taskCard.querySelector('.name').textContent);
            (0,_ui_forms_editTaskModal__WEBPACK_IMPORTED_MODULE_5__["default"])(taskObj);
        }

        if (target.classList.contains('task-complete-btn')) {
            (0,_completeTask__WEBPACK_IMPORTED_MODULE_11__.completeTask)(target.parentElement);
        }
    });
})();
...
/* harmony import */ var _ui_forms_newTaskForm__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../ui/forms/newTaskForm */ "./src/ui/forms/newTaskForm.js");
/* harmony import */ var _ui_forms_removeModal__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../ui/forms/removeModal */ "./src/ui/forms/removeModal.js");
/* harmony import */ var _ui_refreshContent__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../ui/refreshContent */ "./src/ui/refreshContent.js");
/* harmony import */ var _localStorage__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./localStorage */ "./src/app/localStorage.js");
...
function createTask() {
    ...
    if (title) {
        ...
        newTask.add();
        (0,_localStorage__WEBPACK_IMPORTED_MODULE_6__.saveToLocalStorage)(_task__WEBPACK_IMPORTED_MODULE_2__.allTasks);
    }

    // close the form?
    (0,_ui_refreshContent__WEBPACK_IMPORTED_MODULE_5__["default"])();
}

function editTask() {
    console.log("what's up?");
    (0,_ui_forms_removeModal__WEBPACK_IMPORTED_MODULE_4__["default"])();
}
...
function createProject() {
    ...
    if (title) {
        ...
        newProject.add();
        (0,_localStorage__WEBPACK_IMPORTED_MODULE_6__.saveToLocalStorage)(_app__WEBPACK_IMPORTED_MODULE_1__.allProjects);
    }
    (0,_ui_forms_removeModal__WEBPACK_IMPORTED_MODULE_4__["default"])();
    (0,_ui_refreshContent__WEBPACK_IMPORTED_MODULE_5__["default"])();
}
    ...
    if (data === _task__WEBPACK_IMPORTED_MODULE_1__.allTasks) {
        ...
        if (deserializedData !== null) {
            deserializedData.forEach((item) => {
                ...
                item.dueDate = (0,date_fns_parseISO__WEBPACK_IMPORTED_MODULE_2__["default"])(item.dueDate);
            });
    ...
    const createForm = (function() {
        ...
        const createMetaInputContainer = (function() {
            ...
            const createProjectInput = (function() {
                ...
                for (let i = 0; i < _app_app__WEBPACK_IMPORTED_MODULE_0__.allProjects.length; i++) {
                    const option = projectInput.appendChild(_mainContainer__WEBPACK_IMPORTED_MODULE_1__.d.createElement('option'));
                    option.value = _app_app__WEBPACK_IMPORTED_MODULE_0__.allProjects[i].title;
                    option.textContent = _app_app__WEBPACK_IMPORTED_MODULE_0__.allProjects[i].title;
                }
    ...
    const createForm = (function() {
        ...
        const createMetaInputContainer = (function() {
            ...
            const createProjectInput = (function() {
                ...
                if (_app_app__WEBPACK_IMPORTED_MODULE_0__.allProjects.some((project) => project.title === viewName)) {
...
function refreshContent() {
    ...
    const getCurrentView = function() {
        ...
        switch (viewName) {
            case 'Inbox':
                return _app_app__WEBPACK_IMPORTED_MODULE_3__.inboxView;
                break;
            case 'Today':
                return _app_app__WEBPACK_IMPORTED_MODULE_3__.todayView;
                break;
            case 'Week':
                return _app_app__WEBPACK_IMPORTED_MODULE_3__.weekView;
                break;
            default:
                return _app_app__WEBPACK_IMPORTED_MODULE_3__.allProjects.find((project) => project.title === viewName);
        }
    }
...
function createSidebar() {
    ...
    const createTopViewListContainer = (function() {
        ...
        const createBtnsContainer = (function() {
            ...
            inboxViewBtn.innerHTML = `<i class="fa-solid fa-inbox"></i>${_app_app__WEBPACK_IMPORTED_MODULE_0__.inboxView.title}<span>${_app_app__WEBPACK_IMPORTED_MODULE_0__.inboxView.getTasks().length}</span>`
            ...
            todayViewBtn.innerHTML = `<i class="fa-solid fa-calendar-day"></i>${_app_app__WEBPACK_IMPORTED_MODULE_0__.todayView.title}<span>${_app_app__WEBPACK_IMPORTED_MODULE_0__.todayView.getTasks().length}</span>`
            ...
            weekViewBtn.innerHTML = `<i class="fa-solid fa-calendar-week"></i>${_app_app__WEBPACK_IMPORTED_MODULE_0__.weekView.title}<span>${_app_app__WEBPACK_IMPORTED_MODULE_0__.weekView.getTasks().length}</span>`;
    ...
    const createProjectsViewListContainer = (function() {
        ...
        const createBtnsContainer = (function() {
            ...
            for (let i = 0; i < _app_app__WEBPACK_IMPORTED_MODULE_0__.allProjects.length; i++) {
                ...
                btn.innerHTML = `<i class="fa-solid fa-list-check"></i>${_app_app__WEBPACK_IMPORTED_MODULE_0__.allProjects[i].title}<span>${_app_app__WEBPACK_IMPORTED_MODULE_0__.allProjects[i].getTasks().length}</span>`
            }
        })();
    })();
...
const init = (function() {
    ...
    (0,_ui_viewContainer__WEBPACK_IMPORTED_MODULE_4__.createViewContainer)(_app_app__WEBPACK_IMPORTED_MODULE_1__.inboxView);
})();
